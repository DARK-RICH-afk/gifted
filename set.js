...
global.caption = "*©𝟐𝟎𝟐𝟒 𝐊𝐋𝐀𝐔𝐒 𝐕𝟓*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~Gmo1QAIS#VSdytTwYyTT62gA3EP6HhMuOn7sOGer5HjV-gbuU-s4", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "50931461936", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝐊𝐋𝐀𝐔𝐒", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || " 𝙎-𝙏𝞢𝞜", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || " 𝙎-𝙏𝞢𝞜💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || " 𝙎-𝙏𝞢𝞜", // Input Yours custom...(Maintain font for Flow)
